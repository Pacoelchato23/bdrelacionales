...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-03-2025 a las 01:08:02
...
ALTER TABLE `productos`
  ...
  ADD KEY `categoría_id_2` (`categoría_id`);
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `productos_ibfk_1` FOREIGN KEY (`categoría_id`) REFERENCES `categorias` (`id`);
